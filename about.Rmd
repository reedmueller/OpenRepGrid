...
If you use `OpenRepGrid` in your work, please cite it as follows.

Heckmann, M. (2016). *OpenRepGrid: An R package for the analysis of repertory grids*. R package version 0.1.10. Available from: https://cran.r-project.org/package=OpenRepGrid.
